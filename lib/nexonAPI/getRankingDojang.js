 ...
 * @param {String} difficulty 구간 (0:일반, 1:통달)
 ...
 * @returns 
 */
export const getRankingDojang = async (worldName, difficulty, character_class, ocid, page, selected_date) => {
    if (selected_date) {
    ...
    try {
        const url = new URL("https://open.api.nexon.com/maplestory/v1/ranking/dojang");
